                  ...
                  <div class="p-8">
                    ...
                    <div class="space-y-3">
                      <a
                        ...
                        class="block w-full py-4 px-6 rounded-2xl font-semibold border-2 border-indigo-600 text-indigo-600 transition-all hover:bg-indigo-50 text-center cursor-pointer"
                      >
                        View Details →
                      </a>
